...
public class BlueAutoFar9Path extends OpMode {
    ...
    private final Pose intake1Pose = new Pose(13.717912552891397, 35.54301833568405, Math.toRadians(0));
    ...
    private PathChain driveStartPosShootPos, driveShootPosLineIntake1Pos, driveLineIntake1PosIntake1Pos, driveIntake1PosShootPos,
            driveShootPosLineIntake2Pos, driveLineIntake2PosIntake2Pos, driveIntake2PosShootPos, driveShootPosLeavePos;
