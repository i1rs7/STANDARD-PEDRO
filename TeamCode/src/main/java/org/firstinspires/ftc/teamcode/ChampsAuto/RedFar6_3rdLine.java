...
public class RedFar6_3rdLine extends OpMode {
    ...
    private final Pose shootPose2 = new Pose(145-56, 12, Math.toRadians(180-115));
    private final Pose lineIntake1Pose = new Pose(145-44, 32, Math.toRadians(180));
    private final Pose intake1Pose = new Pose(145-7.08416494712284, 32, Math.toRadians(180));
