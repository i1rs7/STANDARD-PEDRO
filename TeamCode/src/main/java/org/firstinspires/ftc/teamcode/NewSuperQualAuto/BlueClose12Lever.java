...
public class BlueClose12Lever extends OpMode {
    ...
    public enum PathState {
        ...
        DRIVE_SHOOTPOSE2_CONTROLLEVERPOSE1, STARTINTAKE2,DRIVE_CONTROLLEVERPOSE1_LEVERPOSE1,STOPINTAKE2, // intake 2 (lever)
    ...
    private final Pose shootPose1 = new Pose(55.85680170543313, 92.07533215512152, Math.toRadians(180-47));
    private final Pose shootPose2 = new Pose(53.856801705433135, 87.34008052590521, Math.toRadians(180-48));
    ...
    private final Pose leverPose1 = new Pose(13.54823695345557, 89.60157710801516, Math.toRadians(180-220));
    private final Pose lineIntake2Pose = new Pose(56.97981157469717, 87.07533215512152, Math.toRadians(180-180));
    private final Pose intake2Pose = new Pose(21.197060671580733, 87.07533215512152, Math.toRadians(180-180));
    ...
    private PathChain driveStartPosShootPos, driveShootPos1LineIntake1Pos, driveLineIntake1PosIntake1Pos, driveIntake1PosShootPos2,
            driveShootPos2ControlLeverPose1, driveControlLeverPose1LeverPose1, driveLeverPose1ShootPose3, driveShootPos3LineIntake2,
