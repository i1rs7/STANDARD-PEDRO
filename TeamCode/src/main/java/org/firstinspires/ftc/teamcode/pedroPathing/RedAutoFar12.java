...
public class RedAutoFar12 extends OpMode {
    ...
    private final Pose intake1Pose = new Pose(136.2820874471086, 35.54301833568405, Math.toRadians(180));
    ...
    private final Pose lineIntake3Pose = new Pose(136.2820874471086, 35.74612129760225, Math.toRadians(90));
    private final Pose intake3Pose = new Pose(136.688293370945, 7.108603667136817, Math.toRadians(90));
