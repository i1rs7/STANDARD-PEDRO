...
public class RedClose12Lever extends OpMode {
    ...
    private final Pose leverPose1 = new Pose(145-11.54823695345557, 70.60157710801516, Math.toRadians(220));
    private final Pose hitLeverPose = new Pose(145-11.54823695345557, 66, Math.toRadians(220));
