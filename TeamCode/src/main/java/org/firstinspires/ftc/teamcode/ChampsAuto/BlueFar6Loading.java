...
@Autonomous
public class BlueFar6Loading extends OpMode {
    ...
    private final Pose lineIntake1Pose = new Pose(29.448183041722736, 8.77523553162853, Math.toRadians(90));
    private final Pose intake1Pose = new Pose(9, 8.77523553162853, Math.toRadians(180-180));
