...
public class Shooting_BlueAutoClose9Lever extends OpMode {
    ...
    private final Pose intake1Pose = new Pose(14.584870165740611, 84.26914103802865, Math.toRadians(0));
        ...
        switch (pathState) {
            ...
            case DRIVE_LINEINTAKE2POSE_INTAKE2POSE:
                if(!follower.isBusy()){
                    ...
                    follower.followPath(driveLineIntake2PosIntake2Pos, 0.2, true);
