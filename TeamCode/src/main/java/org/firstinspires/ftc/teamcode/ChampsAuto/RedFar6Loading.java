...
public class RedFar6Loading extends OpMode {
    ...
    private final Pose shootPose1 = new Pose(145-56, 16, Math.toRadians(67));
    private final Pose shootPose2 = new Pose(145-56, 12, Math.toRadians(69));
    private final Pose lineIntake1Pose = new Pose(145-45.448183041722736, 17.77523553162853, Math.toRadians(180));
    private final Pose intake1Pose = new Pose(145-9, 10.77523553162853, Math.toRadians(180));
